        ...
        scrollX: true,
          ...
          columns:[
          {
                data: function(row){
                    ...
                    str+= "&nbsp;<button id='btnEditar' class = 'btn btn-success btn-xs' onClick = 'showAlumno("
                      +row['no_control']+
                      ",\""+row['carrera']+"\""+
                      ",\""+row['semestre']+"\""+
                      ",\""+row['status']+"\""+
                      ...
                      ",\""+row['periodo_ingreso']+"\""+
                      ",\""+row['promedio']+"\""+
                      ",\""+row['creditos_aprobados']+"\""+
                      ",\""+row['creditos_cursados']+"\""+
                      ",\""+row['email']+"\""+
                      ",\""+row['nacionalidad']+"\""+
                      ",\""+row['nip']+"\""+
