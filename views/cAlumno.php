                ...
                <form  id="frmEditAlumno">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="carrera2" id="carrera2" class="form-control"></select>
                        </div>
                    </div><!--
                    <div class="form-group">
                        <label class="control-label" for="carrera2">Carrera:</label>
                    ...
                    <div class="form-group">
                        <label class="control-label" for="periodo_ingreso2">Periodo de ingreso:</label>
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="glyphicon glyphicon-eye-close"></i>
                            </span>
                            <input class="form-control" type="text" id="periodo_ingreso2" name="periodo_ingreso2" placeholder="Ingrese el periodo de ingreso">
                        </div>
                    </div>
